...
HD_PWD='D:/vivado_project/genepattren/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log GenePattern.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source GenePattern.tcl
